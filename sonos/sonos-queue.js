...
module.exports = function(RED) {
    ...
    function Node(n) {
        ...
        node.client.queueNext(_songuri).then((result) => {
        ...
        node.client.play(_songuri).then((result) => {
        ...
        node.client.playTuneinRadio(_songuri).then((result) => {
        ...
        node.client.queue(_songuri, set_position).then((result) => {
